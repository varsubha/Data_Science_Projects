...
library(rpart)
library(rpart.plot)
mower.df <- read.csv("C:/Users/Administrator/Documents/MSBA/TN560A/Chapter3&4/RidingMowers.csv")
```
...
bank.df <- read.csv("C:/Users/Administrator/Documents/MSBA/TN560A/Chapter3&4/UniversalBank.csv")
...
length(deeper.ct$frame$var[deeper.ct$frame$var == "<leaf>"]) #47
# plot tree
...
length(pruned.ct$frame$var[pruned.ct$frame$var == "<leaf>"]) #length reduced from 47 to 7. In order to avoid overfitting
